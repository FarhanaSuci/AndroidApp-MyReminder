...
import com.example.smartalarm.databinding.ActivityMaps2Binding;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(@NonNull Marker marker) {
                ...
                Toast.makeText(MapsActivity2.this, "Marker"+ marker.getTitle()+"was clicked "+ marker.getTag()+" times", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
    }
