...
import com.example.smartalarm.databinding.ActivityRegisterBinding;
                ...
                new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            //Toast.makeText(register.this, "Successfully create account,Check email to verify", Toast.LENGTH_SHORT).show();
