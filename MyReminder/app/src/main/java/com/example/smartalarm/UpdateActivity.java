...
import com.example.smartalarm.databinding.ActivityUpdateBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnUpdateTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //firebaseFirestore.collection("transation").document(id)
                //firebaseFirestore.collection("MyExpense").document(getIntent().getStringExtra(id))
